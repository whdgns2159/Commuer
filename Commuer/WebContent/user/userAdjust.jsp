		  	...
		  	<table class="table table-borderless" id="userAdjust" >
			    ...
			    <tbody id="uaTbody">
			      <tr>
			        <td width="10%">닉네임</td>
			        <td>
				       <input type="text" class="form-control" id="userNick" name="userNick" value="${currentUInfo.nickname}">
			        </td>
			        <td width="20%"> 
			      ...
			      <tr>
			        <td width="10%">이메일</td>
			        <td>
				        <input type="email" class="form-control" id="userEmail" name="userEmail" value="${currentUInfo.email}">
			        </td>
			        <td width="20%">
			      ...
			      <tr>
			        <td width="10%">연락처</td>
			        <td>
				        <input type="tel" class="form-control" id="userTel" name="userTel" value="${currentUInfo.tel}">
			        </td>
			        <td width="20%"> 
